...
import java.net.URL;
import java.util.*;
// S. Merkel, included for new mouse event model
...
**************************************************************************
**   
**    Slightly modified by Sebastien Merkel 03/2005 to send event signals 
**    from another gui.
**    Modified by S. Merkel 03/2006 to use java.awt.event.MouseEvent instead of
**    deprecated methods...
**
**************************************************************************
**
...
public class G2Dint extends Graph2D {
	...
	*/
	...
	// S. Merkel: added a constructor to record mouse events
	public G2Dint() {
		MyListener myListener = new MyListener();
		addMouseListener(myListener);
		addMouseMotionListener(myListener);
	}
	// S. Merkel: inner class that traks and handle mouse events
	private class MyListener extends MouseInputAdapter {
		public void mousePressed(MouseEvent e) {
			...
			else if(x0 > datarect.x + datarect.width ) x0 = datarect.x + datarect.width;
			if(y0 < datarect.y) y0 = datarect.y;
			else if(y0 > datarect.y + datarect.height ) y0 = datarect.y + datarect.height;
			repaint();
		}
	...
	*/
	...
	/**
	* Added by S. Merkel 03/2005
	* Allow to send event similar to  Key Down events from another GUI.
	*/
	public boolean triggerKeyEvent(char key) {
		if(xaxis==null || yaxis==null) return false;
		switch ( key ) {
			case 'R':
				xaxis.resetRange();
	...
	* Removed by S. Merkel, new mouse event system...
	*/
